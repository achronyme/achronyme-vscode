...
const KEYWORDS = [
    ...
    { label: 'match', kind: vscode.CompletionItemKind.Keyword, detail: 'Pattern matching expression' },
    { label: 'try', kind: vscode.CompletionItemKind.Keyword, detail: 'Try block for error handling' },
    { label: 'catch', kind: vscode.CompletionItemKind.Keyword, detail: 'Catch block for error handling' },
    { label: 'throw', kind: vscode.CompletionItemKind.Keyword, detail: 'Throw an error' },
...
const TYPES = [
    ...
    { label: 'Record', kind: vscode.CompletionItemKind.TypeParameter, detail: 'Key-value object type' },
    { label: 'Error', kind: vscode.CompletionItemKind.TypeParameter, detail: 'Error value type' },
    { label: 'Function', kind: vscode.CompletionItemKind.TypeParameter, detail: 'Callable function type' },
    { label: 'Null', kind: vscode.CompletionItemKind.TypeParameter, detail: 'Null/absence value type' },
...
export function activate(context: vscode.ExtensionContext) {
    ...
    // Register completion provider (fallback when LSP doesn't provide completions)
    ...
    const restartCommand = vscode.commands.registerCommand('achronyme.restartServer', async () => {
        ...
        vscode.window.showInformationMessage('Achronyme Language Server restarted');
    });
